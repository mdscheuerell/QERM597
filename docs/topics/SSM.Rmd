...
## Density-dependent population growth | Stochastic Gompertz model

$$
N_t = N_{t-1} \text{e}^{[u ~ + ~ (b - 1) \log(N_{t-1})]} \text{e}^{w_t} \\
w_t \sim \text{N}(0,q)
$$
...
## Density-dependent population growth | Model fitting
